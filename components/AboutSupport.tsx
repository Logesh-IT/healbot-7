        ...
        <section className="bg-slate-900 p-8 rounded-[3rem] text-white overflow-hidden relative group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
            <div>
              ...
              <p className="font-mono font-bold text-sm tracking-widest">{userProfile.patientId}</p>
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
           <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm">
             ...
             <div className="space-y-6">
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   <p className="text-xs font-black uppercase text-slate-900">Lokiverse Factory</p>
               ...
               <div className="grid grid-cols-1 gap-3">
                 ...
                 <a href="https://www.lokiversefactory.com" target="_blank" className="flex items-center gap-4 p-4 bg-slate-50 rounded-2xl hover:bg-blue-50 transition-colors">
                    <i className="fas fa-globe text-blue-500"></i>
                    <span className="text-xs font-bold text-slate-700">www.lokiversefactory.com</span>
                 </a>
               </div>
           ...
           <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm flex flex-col justify-center items-center text-center">
             ...
             <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 w-full">
               <p className="text-xl font-black text-blue-600 uppercase tracking-widest mb-1">Lokiverse Factory</p>
      ...
      <footer className="mt-auto bg-white border-t border-slate-200 p-6 no-print">
        ...
        <div className="mt-6 text-center">
          <p className="text-[9px] font-black text-slate-300 uppercase tracking-[0.6em]">
            AI healthcare assistant • Secure data • Developed by Lokiverse Factory
          </p>
        </div>
      </footer>
    </div>
